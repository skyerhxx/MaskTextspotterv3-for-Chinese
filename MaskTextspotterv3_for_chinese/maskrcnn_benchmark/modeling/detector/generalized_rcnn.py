...
class GeneralizedRCNN(nn.Module):
    ...
    def forward(self, images, targets=None):
        ...
        #self.backbone是ResNet50
        #features是tuple, len是5
        # torch.Size([1, 256, 256, 400])
        # torch.Size([1, 256, 128, 200])
        # torch.Size([1, 256, 64, 100])
        # torch.Size([1, 256, 32, 50])
        # torch.Size([1, 256, 16, 25])
        ...
        if self.cfg.MODEL.SEG_ON and not self.training:
            ...
            #self.proposal是segmentation.py中的SEGModule
            #返回结果的proposal就是对应的boxes

            #proposals是list, len为1
            # print(proposals[0])
